package com.panpraz.eventlunas.service;
...
public class PublisherService {
    ...
    public void sendingMessagetoSolace(String data, String strTopic) throws JCSMPException{
        ...
        try {
            ...
            logger.info("Message has been sent to solace MSG: {} Topic: {}",data,strTopic);
        } catch (Exception e) {
            session.closeSession(); // force close session on error
